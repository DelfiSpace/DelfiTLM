...
class TestSubmitFrames(TestCase):
    ...
    def test_submit_with_timestamps(self):
        ...
        response = self.client.post(reverse('login'), {'username': 'user', 'password': 'delfispace4242'})
        self.assertEqual(response.status_code, 200)
        frame = '{ "qos": 98.6, "frame_time": "2021-12-19T02:20:14.959630Z", "timestamp": "2021-12-19T02:20:14.959630Z", "send_time": "2021-12-19T02:20:14.959630Z", "frequency": 2455.66, "frame": ""}'
    ...
    def test_submit_bad_key(self):
        ...
        response = self.client.post(reverse('login'), {'username': 'user', 'password': 'delfispace4242'})
        self.assertEqual(response.status_code, 200)
        frame = '{ "qos": 98.6, "frame_time": "2021-12-19T02:20:14.959630Z", "receive_time": "2021-12-19T02:20:14.959630Z", "send_time": "2021-12-19T02:20:14.959630Z", "frequency": 2455.66, "frame": ""}'
